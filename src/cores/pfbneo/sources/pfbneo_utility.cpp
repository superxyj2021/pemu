...
//  gameInfo.parent = game.cloneOf;
//  gameInfo.manufacturer = game.developer.name;
//  gameInfo.players = game.playersInt;
//	gameInfo.sysId = game.system.id;
//  gameInfo.sysName = game.system.name;
